...
)
{
	...
	write_ascfile(root, -1, "", Arrptr->H, nullptr, 0, &states, Parptr, C(-9999.0), "%.17");
	write_ascfile(root, -1, "1x", Arrptr->H1x, nullptr, 0, &states, Parptr, C(-9999.0), "%.17");
	write_ascfile(root, -1, "1y", Arrptr->H1y, nullptr, 0, &states, Parptr, C(-9999.0), "%.17");
}
